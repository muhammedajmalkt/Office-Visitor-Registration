...
const CheckIn = () => {
  ...
  useEffect(() => {
    ...
    const requestCameraPermission = async () => {
      try {
        ...
        setCameraError(true);
        alert(
          "Camera access is required for visitor registration. Please allow camera access."
        );
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      alert("All required fields, including office selection, must be filled.");
      return;
    }
    ...
    formDataToSend.append("office", selectedOffice);
    setLoading(true);
    try {
      ...
      >
        <div className="bg-gradient-to-r from-white-600 to-white-800 text-white p-5 flex flex-col items-center">
          <img
            ...
            className="h-20 mb-3"
          />
          <h1 className="text-2xl sm:text-3xl font-bold text-center tracking-wide text-blue-900 p-2">
            YES INDIA FOUNDATION
          </h1>
          <h2 className="text-xl sm:text-2xl font-bold text-center tracking-wide text-blue-900 p-2">
            {selectedOffice
              ? offices.find((o) => o.value === selectedOffice)?.label
              : "Select Office"}
          </h2>
          <p className="text-base sm:text-lg mt-1 font-medium text-gray-600">
            Visitor Register
          </p>
        </div>
        ...
        {success ? (
          ...
          >
            ...
            <p className="text-gray-600 text-lg">
              Welcome to YES INDIA FOUNDATION.
            </p>
          </motion.div>
        ) : (
          <>
            {step === 0 ? (
              <div className="p-5">
                ...
                <div className="grid grid-cols-3 gap-3 max-h-[300px] overflow-y-auto scrollbar-hidden">
                  {offices.map((office) => (
                    <motion.button
                      key={office.value}
                      className="py-3 px-4 bg-blue-800 hover:bg-blue-700 text-white rounded-lg text-base font-medium shadow-md"
                      whileTap={{ scale: 0.95 }}
                      onClick={() => handleOfficeSelect(office.value)}
                    >
                      {office.label}
                    </motion.button>
                  ))}
              ...
              <div className="p-5">
                <div className="mb-5">
                  <p className="text-center text-gray-700 mb-3 font-medium">
                    Please look at the camera and take your photo
                  </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
                  <div className="sm:col-span-2">
                    <label className=" text-gray-700 font-medium mb-1 flex items-center">
                      <User className="mr-2 text-blue-600" size={18} /> Full
                  ...
                  <div className="sm:col-span-2">
                    <label className=" text-gray-700 font-medium mb-1 flex items-center">
                      <Smartphone className="mr-2 text-blue-600" size={18} />{" "}
                  ...
                  <div>
                    <label className=" text-gray-700 font-medium mb-1 flex items-center">
                      <ClipboardList className="mr-2 text-blue-600" size={18} />{" "}
                      ID Type
                    </label>
                    <select
                      name="idType"
